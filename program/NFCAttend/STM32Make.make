...
../Bsp/Key/key.c \
../Bsp/LED/led.c \
../Bsp/UartDrv/uart_drv.c \
../Bsp/RTC/bsp_rtc.c \
../Bsp/w25qxx/w25qxx.c \
../Bsp/NFC/rc522.c \
../Bsp/NFC/rc522_platform_stm32.c \
../Bsp/OLED/ssd1306.c \
../Bsp/OLED/ssd1306_i2c.c \
../Bsp/OLED/GUISlim.c \
../Bsp/OLED/F08_ASCII.c \
../Bsp/MIDI/midi.c \
../Bsp/delay/delay_us.c \
App/Src/app_main.c \
App/Src/app_tasks.c \
App/Src/card_format.c \
App/Src/display.c \
App/Src/key_proc.c \
App/Src/nfc_app.c \
App/Src/protocol.c \
...
ifdef ARM_GCC_PATH
    # 加双引号包裹路径，避免路径中含空格或特殊字符导致 sh 转义失败
    CC = "$(ARM_GCC_PATH)/$(ARM_PREFIX)gcc.exe"
    CXX = "$(ARM_GCC_PATH)/$(ARM_PREFIX)g++.exe"
    AS = "$(ARM_GCC_PATH)/$(ARM_PREFIX)gcc.exe" -x assembler-with-cpp
    CP = "$(ARM_GCC_PATH)/$(ARM_PREFIX)objcopy.exe"
    SZ = "$(ARM_GCC_PATH)/$(ARM_PREFIX)size.exe"
    DP = "$(ARM_GCC_PATH)/$(ARM_PREFIX)objdump.exe"
else
  CC ?= $(ARM_PREFIX)gcc
  CXX ?= $(ARM_PREFIX)g++
